...
public class CustomerServiceImpl implements CustomerService {
	...
	public Page<Customer> findCustomerList(Integer page, Integer rows,
			...
			String custLevel, String custType, String custState,
			String custSchedule) {
		// 创建客户对象
		...
		if (StringUtils.isNotBlank(custType)) {
			customer.setCust_type(custType);
		}
		// 年营业额
		...
		// 判断客户跟进进度
		if (StringUtils.isNotBlank(custSchedule)) {
			customer.setCust_schedule(custSchedule);
		}
		// 当前页
