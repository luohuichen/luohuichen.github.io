...
<body>
	<!-- 客户列表查询部分  start-->
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">客户基础信息</h3>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" method="get"
						action="${pageContext.request.contextPath }/customer/list1.action">
						...
						<div class="form-group">
							<label for="custIndustry">业务员</label> <select
		           ...
		           data-target="#newCustomerDialog" onclick="clearCustomer()"><i class="fa fa-plus-square-o fa-fw"></i>新建客户信息</a> 
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itheima:page
								url="${pageContext.request.contextPath }/customer/list1.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
					...
					<form class="form-horizontal" id="new_customer_form">
						...
						<div class="form-group">
							<label for="new_custIndustry"
								style="float: left; padding: 7px 28px 0 27px;">业务员</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="new_customerleibi"
								style="float: left; padding: 7px 15px 0 27px;">客户类型</label>
							<div class="col-sm-10">
								<select class="form-control" id="new_customerleibi"
									name="cust_type">
									<option value="">--请选择--</option>
						...
						<div class="form-group">
							<label for="new_custstate"
								style="float: left; padding: 7px 15px 0 27px;">年营业额</label>
							<div class="col-sm-10">
								<select class="form-control" id="new_custstate"
									name="cust_state">
									<option value="">--请选择--</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" id="new_schedule"
									name="cust_schedule">
									<option value="">--请选择--</option>
									<c:forEach items="${scheduleType}" var="item">
										<option value="${item.dict_id}"
											<c:if test="${item.dict_id == custSchedule}"> selected</c:if>>${item.dict_item_name }</option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="new_progress" class="col-sm-2 control-label">最新进展</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="new_progress"
